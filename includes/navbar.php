...
<nav id="nb" role="navigation" aria-label="Main navigation">
  <a href="/new-logixcode/" class="logo" aria-label="LogixCode Home">
  ...
  <ul class="nlinks" id="nl" role="menubar">
    <li><a href="/new-logixcode/" <?= $pg==='index' ? 'class="ac"' : '' ?> role="menuitem">Home</a></li>

    <!-- SERVICES WITH MEGA DROPDOWN -->
    <li class="has-drop">
      <a href="/new-logixcode/services" <?= $pg==='services' ? 'class="ac"' : '' ?> role="menuitem">
        Services
        <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6 9l6 6 6-6"/></svg>
      </a>
      <div class="mega-drop" role="menu">
        <div class="mega-grid">
          <a href="/new-logixcode/software-development" class="mega-item">
          ...
          <a href="/new-logixcode/website-development" class="mega-item">
          ...
          <a href="/new-logixcode/mobile-app-development" class="mega-item">
          ...
          <a href="/new-logixcode/digital-marketing" class="mega-item">
          ...
          <a href="/new-logixcode/erp-crm" class="mega-item">
          ...
          <a href="/new-logixcode/graphics-design" class="mega-item">
          ...
          <a href="/new-logixcode/ai-ml" class="mega-item">
          ...
          <a href="/new-logixcode/hosting" class="mega-item">
        ...
        <div class="mega-footer">
          <a href="/new-logixcode/services">View All Services &rarr;</a>
        </div>
      </div>
    </li>
 <li><a href="/new-logixcode/about" <?= $pg==='about' ? 'class="ac"' : '' ?> role="menuitem">About</a></li>
    <li><a href="/new-logixcode/industries" <?= $pg==='industries' ? 'class="ac"' : '' ?> role="menuitem">Industries</a></li>
    <li><a href="/new-logixcode/portfolio" <?= $pg==='portfolio' ? 'class="ac"' : '' ?> role="menuitem">Portfolio</a></li>
    <li><a href="/new-logixcode/blog" <?= $pg==='index' && strpos($_SERVER['REQUEST_URI'], 'blog') !== false ? 'class="ac"' : ($pg==='blog' ? 'class="ac"' : '') ?> role="menuitem">Blog</a></li>
    <li><a href="/new-logixcode/contact" <?= $pg==='contact' ? 'class="ac"' : '' ?> role="menuitem">Contact</a></li>
  </ul>

  <a href="/new-logixcode/contact" class="ncta">Get Quote</a>
